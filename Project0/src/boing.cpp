...
int main()
{
	...
	while (!glfwWindowShouldClose(engine.window))
	{
		...
		// RENDER
		light.DrawColor(lightsColors[0]);

		player.DrawLitTexture(LIGHTS_NUMBER, lightsColors, lightsPositions, 0, GL_TEXTURE0, unlitBaseTexture, 1, GL_TEXTURE1, normalsTex);
